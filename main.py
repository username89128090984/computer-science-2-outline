                ...
                case 1:
                    while True:
                        ...
                        match choice:
                            ...
                            case 2:
                                print(
                                    "[PLACEHOLDER - finish scheduler first, then insert code for retrieval from file]")
                            case _:
                    ...
                    while True:
                        ...
                        match choice:
                            case 1:
                                activityData["name"] = input("Enter a name for the activity... ")
                                activityData["type"] = input("Is this an AA or an FA? ").upper()
                                activityData["deadline"] = datetime.datetime.strptime(
                                    input("When is this due? (mm/dd/yyyy) "), dateFormat)
                                print()
